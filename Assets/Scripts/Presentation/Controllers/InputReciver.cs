public class InputReciver : IInputReceiver
{
    private readonly PlayerMovementService _movementService;
    private readonly AttackUseCase _attackUserCase;

    public InputReciver(PlayerMovementService movementService, AttackUseCase attackService)
    {
    ...
    public void OnMeleeAttackInput() => _attackUserCase.HandleAttack(AttackType.Melee);

    public void OnRangedAttackInput() => _attackUserCase.HandleAttack(AttackType.Ranged);
